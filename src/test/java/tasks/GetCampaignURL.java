...
import stepDefinitions.GetCampaignURLSteps;

import java.io.FileWriter;
import java.io.IOException;


public class GetCampaignURL {

    public static void andWriteToExcel(String currentUrl) throws IOException {
        Document document ;
        FileWriter urlsFile = new FileWriter("src/test/resources/campaign_urls_file.csv");
        urlsFile.write("Category, URLs\n");
        document = Jsoup.connect(GetCampaignURLSteps.currentUrl).get();
